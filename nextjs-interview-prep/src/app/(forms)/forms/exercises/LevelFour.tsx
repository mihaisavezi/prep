...
export default function Level4ComplexForm() {
  ...
  const handleChange = (e) => {
    ...
    // TODO: Parse the name to get section and field (e.g., "personal.firstName")
    // COMPLETE THIS - split the name by '.' to get section and field
    const [section, field] = name.split('.');

      // TODO: Update the nested state correctly
      // COMPLETE THIS - update the specific section and field
      setFormData((prev) => ({
        ...prev,
        [section]: {
          // YOUR LOGIC HERE
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <fieldset className="border p-4 rounded">
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* TODO: Complete the personal information inputs */}
          {/* Add firstName, lastName, and dob inputs with proper names */}
          <div>
      ...
      <fieldset className="border p-4 rounded">
        ...
        <div className="space-y-3">
          {/* TODO: Complete the preferences section */}
          {/* Add newsletter checkbox */}
          {/* Add notifications checkbox */}
          {/* Add theme radio buttons for 'light', 'dark', 'system' */}
          <div>
          ...
          <div>
            <label className="block mb-1">Add Notifications:</label>
            <input
              type="checkbox"
